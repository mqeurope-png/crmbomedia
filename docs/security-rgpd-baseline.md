...
No se deben guardar API keys reales en el repositorio ni en texto plano. Los conectores deben usar variables de entorno o un almacén de secretos y cifrado en reposo antes de producción.

## Auditoría mínima

El MVP registra logins y acciones CRM relevantes en `audit_logs`: creación/edición/desactivación de contactos y empresas, creación de notas y creación de tareas. Las exportaciones y cambios de permisos deberán auditarse en un sprint posterior.
