...
8. **Ajustes de integraciones**: panel interno para preparar AgileCRM, Brevo, Freshdesk y FactuSOL sin llamadas externas ni secretos persistidos.
...
- Viewers solo pueden leer; users crean notas/tareas; managers editan CRM y consultan ajustes de integraciones; admins gestionan usuarios, auditoría y ajustes de integraciones.
